...
- Landing page pública, documentação bilíngue, 19 testes determinísticos e dois laboratórios reais disponíveis.
...
- Migração encadeada 0.2.0 → 0.3.0 → 0.4.0 remove o bloco antigo do CLAUDE.md e preserva a definição editada.
...
- Entrega: protocolo fora do CLAUDE.md (7.895 → 559 chars num upgrade real) e carga sempre-ativa de ~1.900 para ~990 tokens por sessão.
